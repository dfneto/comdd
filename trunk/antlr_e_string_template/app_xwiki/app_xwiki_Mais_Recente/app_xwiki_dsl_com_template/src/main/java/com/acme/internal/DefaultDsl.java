...
//	FileWriter writer = new FileWriter("/home/david/XWIKI/xwiki-enterprise-jetty-hsqldb-2.7.1/webapps/xwiki/Modelo");
	FileWriter writer = new FileWriter("/home/david/comdd/apache-tomcat-7.0.14/webapps/xwiki/Modelo");

	writer.write(modelo);
        writer.close(); 
       
	PrintStream padrao = System.out;
//	PrintStream fileLog = new PrintStream(new File("/home/david/XWIKI/xwiki-enterprise-jetty-hsqldb-2.7.1/webapps/xwiki/CodigoGerado.cpp")); 
	PrintStream fileLog = new PrintStream(new File("/home/david/comdd/apache-tomcat-7.0.14/webapps/xwiki/CodigoGerado.cpp")); 
	System.setOut(fileLog);//Joga tudo que sairia na saída padrão (no caso o código gerado) num arquivo

//	FileReader groupFileR = new FileReader("/home/david/Xwiki/apache-tomcat-6.0.30/webapps/DSL/WEB-INF/classes/Modelo/Template.stg");
//        StringTemplateGroup templates = new StringTemplateGroup(groupFileR);
//        groupFileR.close();

	String templateFileName = "/home/david/XWIKI/xwiki-enterprise-jetty-hsqldb-2.7.1/webapps/xwiki/Template.stg";
...
//	ANTLRFileStream input = new ANTLRFileStream("/home/david/XWIKI/xwiki-enterprise-jetty-hsqldb-2.7.1/webapps/xwiki/Modelo");
	ANTLRFileStream input = new ANTLRFileStream("/home/david/comdd/apache-tomcat-7.0.14/webapps/xwiki/Modelo");
...
//	String saida = "gogogogoifjsdoisjfops";
