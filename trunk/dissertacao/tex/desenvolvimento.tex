...
\subsection{Estuo de caso III}
\label{estudo_de_caso_iii}
Os objetivos do terceiro estudo de caso são os mesmos dos objetivos do segundo estudo de caso: avaliar comparativamente, entre desenvolvedores, o CoMDD com a abordagem tradicional. A avaliação também consiste na coleta de opinião por parte destes usuários.

\subsubsection{Descrição dos participantes}
O experimento 3 foi passado para 42 pessoas, onde 90\% delas eram formadas em algum curso de computação, 83\% já fizeram ou faziam mestrado ou doutorado, 98\% já desenvolveu sistemas em equipe e 90\% já trabalharam ou trabalham em empresas. 79\% dos participantes já trabalharam ou trabalhavam com uma IDE associada à um programa de versionamento. Ainda, o gráfico \ref{grafico:experiencia_programacao} apresenta o número de pessoas pelo tempo em que elas programam em anos. Pode-se observar que a média dos participantes é de 8.22 anos por participante e a moda é de 8 anos.
