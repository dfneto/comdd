...
De acordo com o estudo de caso II, na Seção \ref{estudo_de_caso_ii}, pode-se dizer o CoMDD mostrou ser capaz de atingir os mesmo resultados que o Eclipse+SVN.

Este trabalho apresentou uma proposta para contornar os problemas apresentados na Seção \ref{problema}, bem como evidenciar que é possível desenvolver colaborativamente usando MDD em uma wiki, conforme apresentam as Seções \ref{estudo_de_caso_i}, \ref{estudo_de_caso_ii} e \ref{estudo_de_caso_iii} referentes aos estudos de caso. Ainda, o desenvolvimento de software na wiki é mais fácil do que usar o Eclipse+SVN para os estudos de caso realizados.
